...
!(function (t, e) {
  ...
  function xt(t) {
    ...
    return a
      ? Object.assign(
          ...
          (T[_] = g ? '0' : ''),
          (T.transform =
            (v.devicePixelRatio || 1) < 2 ? 'translate(' + f + 'px, ' + p + 'px)' : 'translate3d(' + f + 'px, ' + p + 'px, 0)'),
          T)
        )
        ...
        for (
          var n = i.mainAxis,
            ...
            v = [m].concat(b).reduce(function (t, i) {
              return t.concat(
                'auto' === dt(i)
                  ? Yt(e, { placement: i, boundary: d, rootBoundary: h, padding: c, flipVariations: p, allowedAutoPlacements: g })
                  : i
              );
            }, []),
            y = e.rects.reference,
  ...
  class qe extends j {
    ...
    show() {
      ...
      if (N.trigger(this._element, 'show.bs.tab', { relatedTarget: t }).defaultPrevented || (null !== n && n.defaultPrevented))
        return;
    ...
    _activate(t, e, i) {
      const s = (
          !e || ('UL' !== e.nodeName && 'OL' !== e.nodeName) ? H.children(e, '.active') : H.find(':scope > li > .active', e)
        )[0],
  ...
  class Qe extends j {
    ...
    show() {
      ...
      if (
        (this._element.classList.remove('hide'), u(this._element), this._element.classList.add('showing'), this._config.animation)
      ) {
